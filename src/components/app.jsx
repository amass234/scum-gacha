...
export default class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      selectedWish: "epitome-invocation",
    ...
    this.setState(
      {
        currentWishes: isOneWish
          ? [this[selectedWish].rollOnce()]
          : this[selectedWish].roll(),
        selectedWish,
      },
      () => this.setView("wish")
    );
  ...
  syncWishCountersWithState() {
    this.setState({
      userWishes: {
        ...
        "invitation-to-mundane-life": this.invitationToMundaneLife.getState()
          .attemptsCount,
        "wanderlust-invocation": this.wanderlustInvocation.getState()
          .attemptsCount,
        ...
        "farewell-of-snezhnaya": this.farewellOfSnezhnaya.getState()
          .attemptsCount,
        ...
        "farewell-of-snezhnaya-2": this.farewellOfSnezhnaya2.getState()
          .attemptsCount,
      },
    });
  }
  ...
  loadData() {
    ...
    if (!data.version) {
      ...
      const { isBeginnersWishLimited, isBeginnersWishOver10, inventory } = data;
      this.beginnersWish.attemptsCount = data.beginnersWishCount || 0;
      this.invitationToMundaneLife.attemptsCount =
        data.invitationToMundaneLife || 0;
      this.wanderlustInvocation.attemptsCount =
        data.wanderlustInvocationCount || 0;
  ...
  setBeginnersWishDisable(isBeginnersWishLimited) {
    ...
    this.setState({
      isBeginnersWishLimited,
      currentDetails: isBeginnersWishLimited
        ? selectedCharacterEventWish
        : "epitome-invocation",
    });
  }
      ...
      case "banners":
        return (
          <Banners
            ...
            getFormattedCharacterEventWish={this.getFormattedCharacterEventWish.bind(
              this
            )}
